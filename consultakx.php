...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1><font color = "white">Pesquisa por nome</font></h1>
        </div>
    </div>

    <form action="pesquisanomekx.php" method="GET">
                
                    <div class="row">
                      <div class="form-group col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" id="pesquisakx" name="pesquisakx" placeholder="Pesquisar por nome">
                            </div>
                            
                            <div class="form-group col-md-12 text-right">
                            <button type="submit" class="btn btn-primary" id=button>Pesquisar</button>
                        </div>
                    </div>
...
<form action="consultavendakx.php" method="GET">
     

<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1><font color = "white">Pesquisa Venda</font></h1>
        </div>
    </div>
...
<div class="form-row">
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="inputProduto" name="produto" placeholder="Insira o nome do produto">>
        </div>
